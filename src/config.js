...
const config = {
  ...
  // IDs قنوات اللوقات
  rolesLogChannelId: process.env.ROLES_LOG_CHANNEL_ID || '1552068234633678961',
  punishmentLogChannelId: process.env.PUNISHMENT_LOG_CHANNEL_ID || '1552068510333796423',
};
